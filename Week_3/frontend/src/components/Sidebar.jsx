...
import { Zap, BarChart3, Cpu, Receipt, Activity, MessageSquare, BookOpen } from 'lucide-react'
...
const aiLinks = [
  ...
  { to: '/qa',   icon: BookOpen,      label: 'Knowledge Base' },
]
                ...
                <>
                  ...
                  {!isActive && (
                    <span className="ml-auto text-xs px-1.5 py-0.5 rounded font-mono"
                      style={{ background: 'rgba(74,222,128,0.1)', color: '#4ade80', fontSize: '9px' }}>
                      NEW
                    </span>
                  )}
                </>
